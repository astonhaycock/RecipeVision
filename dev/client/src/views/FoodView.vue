<script setup lang="ts">
  ...
  const populateRecipes = inject("populateRecipes") as (force: boolean) => Promise<void>;
...
<template>
  <v-main>
    ...
    <IngredientList v-model:ingredients="ingredients" @ingredient-change="populateRecipes(false)" />
  </v-main>
</template>
